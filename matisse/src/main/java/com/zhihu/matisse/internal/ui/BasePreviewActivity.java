...
import com.zhihu.matisse.internal.ui.adapter.PreviewAdapter;
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void updateRecyclerView(){
      ...
      previewAdapter.setItems(mSelectedCollection.asList());
...
//            previewAdapter.notifyDataSetChanged();
        ...
        previewAdapter.setOnItemClickListener(new PreviewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Item item) {
                mPager.setCurrentItem(mAdapter.getItems().indexOf(item));
                previewAdapter.setSelectedPreviewItem(item);
            }
        });
    }
...
//            updateSize(item);
        ...
        if(previewAdapter != null){
            previewAdapter.setSelectedPreviewItem(adapter.getMediaItem(position));
//                linearLayoutManager.scrollToPosition(previewAdapter.getItems().indexOf(item));
        }
